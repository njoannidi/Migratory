...
cliArgs.handle(function()
{
	...
	for(var i in configSettings)
	{
		settingsPrompt.push({name: i + ' ('+configSettings[i].type + " - " + configSettings[i].host + ':' + configSettings[i].database + ')', value: configSettings[i]});
	}
